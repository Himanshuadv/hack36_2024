    ...
    const items = [
        {
          ...
          label: 'What is Motis?',
          content:
            `Motis is a safe space designed for introverted individuals and anyone who wishes to ask questions anonymously. It's a platform where you can connect with others, seek advice, and express yourself freely without revealing your identity.`,
        },
        {
          id: 'lk2j35lkj',
